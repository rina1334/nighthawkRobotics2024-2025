...
public class Four_Sample_Auto_Actions {
    ...
    Vector2d firstSamplePos = new Vector2d(17.32 + 3, -21.12 + 4.25); //17.32, 21.32, 20.32, -22.12
    double firstSampleHeading = Math.toRadians(-90.75);
    Pose2d firstSamplePose = new Pose2d(firstSamplePos, firstSampleHeading);

    Vector2d secondSamplePos = new Vector2d(17.32 + 10.0 + 3, -21.12 + 4.25); //-22.12
    double secondSampleHeading = Math.toRadians(-90.75);
    Pose2d secondSamplePose = new Pose2d(secondSamplePos, secondSampleHeading);

    Vector2d thirdSamplePos = new Vector2d(24.23 + 1, -24.69+2); // x + 2
    double thirdSampleHeading = Math.toRadians(-46.65 - 1); // -1
    ...
    public Four_Sample_Auto_Actions(HardwareMap hardwareMap, Telemetry tele) {
    ...
    public Action setHorizontalExtension() {
        return hSlide.resetHorizontalAction();
    }
...
//    }
    ...
    public Action pickUpThirdSampleAction() {
        return new SequentialAction(
                claw.midOpenClawAction(),
                angleMechanism.loweredAction(),
                //new SleepAction(0.25),
                claw.closeClawAction(),
                new SleepAction(0.25),
