...
//  DON'T LET THE NAME FOOL YOU. THIS IS NOT THE CORRECT FILE. ITS OLD. ITS ANCIENT. ITS OUTDATED.

@Autonomous(group="Isabelle", preselectTeleOp = "Qual2IntoTheDeep")
@Disabled
@Config
public class Qual2_Auto_OTOS_Basket_Zero_Start extends OpMode {
    ...
    double startHeading = Math.toRadians(0); //what angle the robot is at in radians
